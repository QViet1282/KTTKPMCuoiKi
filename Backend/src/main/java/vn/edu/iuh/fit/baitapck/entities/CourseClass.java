...
public class CourseClass {
    ...
    public CourseClass(Long courseClassId, SemesterCourse semesterCourse, int maxStudents, int currentStudents, String location, String instructor, Date startDate, int dayOfWeek, int startPeriod, int endPeriod, int numberOfSessions) {
